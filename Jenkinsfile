pipeline {
    ...
    environment {
        ...
        PORTAINER_DEV_WEBHOOK = credentials('PORTAINER_WEBHOOK_DEV_HANDBRAKE')
        PORTAINER_PRD_WEBHOOK = credentials('PORTAINER_WEBHOOK_PRD_HANDBRAKE')
    }
    ...
    stages {
        ...
        stage('deploy dev code') {
            ...
            steps {
                ...
                sh 'ansible-playbook ${ANSIBLE_REPO}/deploy/docker/deploy_docker_compose_dev.yml --extra-vars repo="handbrake"'
            }
        }
        ...
        stage('deploy prd code') {
            ...
            steps {
                ...
                sh 'ansible-playbook ${ANSIBLE_REPO}/deploy/docker/deploy_docker_compose_prd.yml --extra-vars repo="handbrake"'
            }
        }
